...
public class TelaGerente extends JFrame {
	...
	private JLabel nomeLabel, loginLabel, senhaLabel, telefoneLabel, cpfLabel;
	private JTextField nomeField, loginField, senhaField, telefoneField, cpfField;
	
	private JButton cadasProButton, addButton;
	private JLabel produtoLabel, quantidadeLabel, precoLabel;
	private JTextField produtoField, quantidadeField, precoField;
	...
	public TelaGerente() {
		...
		telefoneLabel.setBounds(275, 160, 100, 30);
		telefoneField.setBounds(325, 160, 100, 30);
		cpfLabel.setBounds(275, 200, 100, 30);
		cpfField.setBounds(325, 200, 100, 30);
		confirmarButton.setBounds(300, 260, 100, 30);
		
		produtoLabel.setBounds(270, 40, 100, 30);
		produtoField.setBounds(325, 40, 100, 30);
		quantidadeLabel.setBounds(250,80, 100, 30);
		quantidadeField.setBounds(325, 80, 100, 30);
		precoLabel.setBounds(275, 120, 100, 30);
		precoField.setBounds(325, 120, 100, 30);
		...
		add(telefoneLabel).setVisible(false);
		add(telefoneField).setVisible(false);
		...
		add(quantidadeLabel).setVisible(false);
		add(quantidadeField).setVisible(false);
